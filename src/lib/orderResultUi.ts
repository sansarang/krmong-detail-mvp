...
export type OrderResultUi = {
  ...
  assetCopyAll: string
  assetCopyBase: string
  assetCopyChannels: string
  assetCopySlots: string
  assetCopySafeZone: string
  assetToastPipeline: string
  assetToastBase: string
  assetToastChannels: string
  assetToastSlots: string
  assetToastSafeZone: string
  assetMicroLabel: string
  assetChannelLinesLabel: string
  assetSafeZoneLabel: string
  assetSlotPlanLabel: string
  intelTitle: string
  intelSub: string
  ...
  intelCopyCompetitorsOnly: string
  intelCopyKeywordsOnly: string
  intelCopyReviewOnly: string
  intelCopyGapOnly: string
  intelToastFull: string
  intelToastCompetitors: string
  intelToastKeywords: string
  intelToastReview: string
  intelToastGap: string
  intelSearchQueriesLabel: string
  metaOgTitle: string
  metaOgSub: string
...
export const ORDER_RESULT_UI: Record<UiLang, OrderResultUi> = {
  ko: {
    ...
    assetSub: '채널·슬롯·비율·안전영역 통합 파이프라인',
    assetThumbLabel: '썸네일 한 줄 (3안)',
    assetRatioLabel: '이미지 비율',
    assetSlotsLabel: '슬롯 체크리스트',
    assetCopyAll: '통합 파이프라인 복사',
    assetCopyBase: '기본 키트만',
    assetCopyChannels: '채널 문구 묶음',
    assetCopySlots: '슬롯 플랜만',
    assetCopySafeZone: '안전 영역만',
    assetToastPipeline: '통합 파이프라인을 복사했습니다',
    assetToastBase: '기본 키트를 복사했습니다',
    assetToastChannels: '채널 문구를 복사했습니다',
    assetToastSlots: '슬롯 플랜을 복사했습니다',
    assetToastSafeZone: '안전 영역 가이드를 복사했습니다',
    assetMicroLabel: '초단문 3안 (스티커·자막)',
    assetChannelLinesLabel: '채널별 3줄',
    assetSafeZoneLabel: '오버레이 안전 영역',
    assetSlotPlanLabel: '이미지 슬롯 S1–S5',
    intelTitle: '데이터 각도 메모',
    intelSub: '경쟁 패턴·키워드·리뷰 각도 — 섹션별 복사 + 검색 쿼리',
    intelCompetitor: '경쟁 상품명 패턴',
    intelKeywords: '카테고리 키워드 힌트',
    intelReviewThemes: '리뷰 불만 반영 질문',
    intelGap: '연동 시 자동화: 리뷰 크롤·카테고리 통계·경쟁사 제목 수집',
    intelCopyChecklist: '인텔 패키지 전체 복사',
    intelCopyCompetitorsOnly: '경쟁 패턴만',
    intelCopyKeywordsOnly: '키워드만',
    intelCopyReviewOnly: '리뷰 각도만',
    intelCopyGapOnly: '연동 메모만',
    intelToastFull: '인텔 패키지를 복사했습니다',
    intelToastCompetitors: '경쟁 패턴을 복사했습니다',
    intelToastKeywords: '키워드 힌트를 복사했습니다',
    intelToastReview: '리뷰 각도를 복사했습니다',
    intelToastGap: '연동 메모를 복사했습니다',
    intelSearchQueriesLabel: '검색 쿼리 샘플',
  ...
  en: {
    ...
    assetSub: 'Channels · slots · ratios · safe zones',
    assetThumbLabel: 'Thumbnail one-liners (3)',
    assetRatioLabel: 'Image ratios',
    assetSlotsLabel: 'Slot checklist',
    assetCopyAll: 'Copy full pipeline',
    assetCopyBase: 'Base kit only',
    assetCopyChannels: 'Channel copy bundle',
    assetCopySlots: 'Slot plan only',
    assetCopySafeZone: 'Safe zones only',
    assetToastPipeline: 'Full pipeline copied',
    assetToastBase: 'Base kit copied',
    assetToastChannels: 'Channel bundle copied',
    assetToastSlots: 'Slot plan copied',
    assetToastSafeZone: 'Safe-zone guide copied',
    assetMicroLabel: 'Micro lines (3) — stickers / captions',
    assetChannelLinesLabel: 'Per-channel 3 lines',
    assetSafeZoneLabel: 'Overlay safe zones',
    assetSlotPlanLabel: 'Image slots S1–S5',
    intelTitle: 'Data-angle notes',
    intelSub: 'Competitor patterns, keywords, review angles — copy by block + search queries',
    ...
    intelCopyChecklist: 'Copy full intel pack',
    intelCopyCompetitorsOnly: 'Patterns only',
    intelCopyKeywordsOnly: 'Keywords only',
    intelCopyReviewOnly: 'Review angles only',
    intelCopyGapOnly: 'Automation note only',
    intelToastFull: 'Full intel pack copied',
    intelToastCompetitors: 'Competitor patterns copied',
    intelToastKeywords: 'Keyword hints copied',
    intelToastReview: 'Review angles copied',
    intelToastGap: 'Automation note copied',
    intelSearchQueriesLabel: 'Sample search queries',
  ...
  ja: {
    ...
    assetSub: 'チャネル・スロット・比率・安全領域',
    assetThumbLabel: 'サムネ一行（3案）',
    assetRatioLabel: '画像比率',
    assetSlotsLabel: 'スロットチェック',
    assetCopyAll: '統合パイプラインをコピー',
    assetCopyBase: '基本キットのみ',
    assetCopyChannels: 'チャネル文まとめ',
    assetCopySlots: 'スロットプランのみ',
    assetCopySafeZone: '安全領域のみ',
    assetToastPipeline: '統合パイプラインをコピーしました',
    assetToastBase: '基本キットをコピーしました',
    assetToastChannels: 'チャネル文をコピーしました',
    assetToastSlots: 'スロットプランをコピーしました',
    assetToastSafeZone: '安全領域ガイドをコピーしました',
    assetMicroLabel: '短文3案（ステッカー・字幕）',
    assetChannelLinesLabel: 'チャネル別3行',
    assetSafeZoneLabel: 'オーバーレイ安全領域',
    assetSlotPlanLabel: '画像スロット S1–S5',
    intelTitle: 'データ視点メモ',
    intelSub: '競合パターン・キーワード・レビュー観点 — ブロック別コピー＋検索クエリ',
    ...
    intelCopyChecklist: 'インテルパックをすべてコピー',
    intelCopyCompetitorsOnly: '競合パターンのみ',
    intelCopyKeywordsOnly: 'キーワードのみ',
    intelCopyReviewOnly: 'レビュー観点のみ',
    intelCopyGapOnly: '連携メモのみ',
    intelToastFull: 'インテルパックをコピーしました',
    intelToastCompetitors: '競合パターンをコピーしました',
    intelToastKeywords: 'キーワードヒントをコピーしました',
    intelToastReview: 'レビュー観点をコピーしました',
    intelToastGap: '連携メモをコピーしました',
    intelSearchQueriesLabel: '検索クエリ例',
  ...
  zh: {
    ...
    assetTitle: '素材与缩略图套件',
    assetSub: '渠道·槽位·比例·安全区整合',
    assetThumbLabel: '缩略图一行（3 套）',
    assetRatioLabel: '图片比例',
    assetSlotsLabel: '槽位清单',
    assetCopyAll: '复制完整流水线',
    assetCopyBase: '仅基础套件',
    assetCopyChannels: '渠道文案包',
    assetCopySlots: '仅槽位计划',
    assetCopySafeZone: '仅安全区',
    assetToastPipeline: '已复制完整流水线',
    assetToastBase: '已复制基础套件',
    assetToastChannels: '已复制渠道文案',
    assetToastSlots: '已复制槽位计划',
    assetToastSafeZone: '已复制安全区说明',
    assetMicroLabel: '超短三句（贴纸·字幕）',
    assetChannelLinesLabel: '分渠道三行',
    assetSafeZoneLabel: '叠字安全区',
    assetSlotPlanLabel: '图片槽位 S1–S5',
    intelTitle: '数据角度备忘',
    intelSub: '竞品模式·关键词·评论角度 — 分块复制 + 搜索词',
    intelCompetitor: '竞品标题模式',
    intelKeywords: '类目关键词提示',
    intelReviewThemes: '差评主题反思',
    intelGap: '可自动化：评论抓取、类目统计、竞品标题',
    intelCopyChecklist: '复制完整情报包',
    intelCopyCompetitorsOnly: '仅竞品模式',
    intelCopyKeywordsOnly: '仅关键词',
    intelCopyReviewOnly: '仅评论角度',
    intelCopyGapOnly: '仅接入说明',
    intelToastFull: '已复制完整情报包',
    intelToastCompetitors: '已复制竞品模式',
    intelToastKeywords: '已复制关键词提示',
    intelToastReview: '已复制评论角度',
    intelToastGap: '已复制接入说明',
    intelSearchQueriesLabel: '搜索词样例',
