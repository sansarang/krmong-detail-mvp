...
export const metadata: Metadata = {
  ...
  description: '스마트스토어·쿠팡 상세페이지를 AI로 5분 만에 자동 생성. SEO 최적화, A/B 카피, 한국어·영어 동시 발행. 무료로 시작하세요.',
  keywords: [
  ...
  openGraph: {
    title: 'AI 상세페이지 자동 생성 | 5분 완성 — 페이지AI',
    description: '스마트스토어·쿠팡 상세페이지를 AI로 5분 만에 자동 생성. SEO 최적화, A/B 카피, 한국어·영어 동시 발행.',
...
const softwareAppSchema = {
  ...
  url: 'https://pagebeer.beer',
  description: 'AI 상세페이지 자동 생성 서비스. 스마트스토어, 쿠팡, Amazon JP, Tmall 등 6개 플랫폼 최적화. 한국어·영어 동시 생성.',
  offers: {
    '@type': 'Offer',
    price: '0',
    priceCurrency: 'KRW',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '페이지AI는 AI로 스마트스토어·쿠팡·Amazon JP·Tmall 등 플랫폼별 최적화 상세페이지를 5분 만에 자동 생성해주는 SaaS 서비스입니다. 제품 정보를 입력하거나 URL을 붙여넣으면 AI가 전문가 수준의 카피를 작성하고, 한국어·영어로 동시 출력합니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '제품 정보 입력 후 평균 30초~2분 이내에 완성됩니다. 한국어·영어 동시 생성도 3분 이내로 처리됩니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '네, 무료 플랜으로 월 5회까지 상세페이지를 생성할 수 있습니다. 프로 플랜(₩39,000/월)은 무제한 생성, 한국어·영어 동시 출력, SEO 분석 리포트 등 모든 기능을 포함합니다.',
      },
    },
    {
      '@type': 'Question',
