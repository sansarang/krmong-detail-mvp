...
6. 투자 요청/다음 단계: 필요 금액, 사용 계획, 마일스톤`
      ...
      sectionGuide = `
[제품 상세페이지 — 동적 섹션 구성 (제품 유형 분석 후 결정)]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🧠 STEP 1: 제품 유형 분석 (반드시 수행)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
제품명과 설명을 분석해서 아래 규칙에 따라 섹션 구성을 결정하라:

❌ 절대 포함 금지 규칙:
• 차량·중고차·오토바이 → "언박싱" "개봉" "포장" 섹션 절대 금지
• 식품·음료·건강식품·원두 → "기술 분석" "공학적 설계" "하드웨어 스펙" 섹션 절대 금지
• 서비스·소프트웨어·디지털 제품 → "언박싱" "실물 사용기" "소재·재질" 섹션 절대 금지
• 의류·패션 → "기계적 스펙표" "회로 설계" 섹션 절대 금지

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🏗️ STEP 2: 섹션 구성 원칙
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
• 섹션 수: 최소 4개, 최대 6개 (제품 복잡도에 따라 결정)
• 섹션 1 (필수): 독자의 공감을 끌어내는 감성적 도입 — 구체적인 상황이나 감정으로 시작
• 마지막 섹션 (필수): 구매 추천이 담긴 요약 정리 — 명확한 CTA 포함

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✍️ STEP 3: 섹션 제목 작성 원칙 (가장 중요)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
섹션 제목은 독자 관점에서 써라. 레이블이 아니라 이야기처럼:
❌ 나쁜 예: "기술 분석", "실제 사용기", "제품 소개", "언박싱"
✅ 좋은 예: "실제로 빠르긴 한 걸까?", "3주 동안 매일 써봤더니", "솔직히 이건 좀 아쉬웠다"

각 섹션 제목은 서로 완전히 다른 문체 사용:
• 의문형 ("왜 이게 이렇게 많이 팔릴까?")
• 선언형 ("숫자가 거짓말하지 않는다")
• 역설형 ("불편한 게 맞는데 계속 쓰게 된다")
• 수치형 ("2만 명이 재구매한 이유 딱 하나")
• 감각형 ("처음 손에 쥐었을 때 느낌")

⚠️ 판에 박힌 패턴 절대 금지:
• "여러분은 이런 불편함이 있으신가요?" — 금지
• "이 제품을 소개합니다" — 금지
• "고객 후기" "스펙표" 같은 레이블식 제목 — 금지
