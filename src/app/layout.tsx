...
export const metadata: Metadata = {
  ...
  title: {
    default: 'PageAI — AI Document & Product Page Generator | 양식·URL → 5분 완성',
    template: '%s | PageAI',
  },
  description: 'Upload any form or URL — AI completes professional documents in 5 minutes, in Korean and English. Auto-optimized for Amazon JP, Tmall, Rakuten, Shopify, Smartstore, Coupang. Business plans, proposals, reports, product pages — any template, expert level.',
  keywords: [
    'AI document generator', 'AI form auto-fill', 'multilingual product page', 'KR EN AI content',
    ...
    '한영 동시생성', '양식 자동작성 AI', 'global seller AI tool', 'PageAI', 'pagebeer',
  ],
  ...
  openGraph: {
    title: 'PageAI — Upload Any Form or URL · AI Completes in 5 Min · KR & EN',
    ...
    type: 'website',
    images: [{ url: 'https://pagebeer.beer/og-image.png', width: 1200, height: 630, alt: 'PageAI — AI Document Generator' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'PageAI — AI Completes Any Document in Korean & English in 5 Minutes',
